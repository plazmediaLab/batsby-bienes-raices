...
const Header = () => {
  ...
  return (
    <header>
      <nav
        className="navbar-component dark bg-primary"
        id="navbar_1"
        ref={navBarItem}
      >
        <Link
        ...
        <div className="navbar-toggle">
          <button
            ...
            onClick={() =>
              navBarActionToggle(navBarItem, btnActions, iconToggle)
            }
          >
        ...
        <div className="navbar-actions split" ref={btnActions}>
          <ul className="navbar-actions_item jc-end">
            <li>
              <Link to="/" className="nav-link" activeClassName="select dial">
                Home
              </Link>
            </li>
            <li>
